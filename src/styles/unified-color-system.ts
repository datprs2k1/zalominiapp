...
export const COLOR_TOKENS = {
  ...
  primary: MEDICAL_COLOR_PALETTE.medical.blue[500],
  'primary-hover': MEDICAL_COLOR_PALETTE.medical.blue[600],
  'primary-active': MEDICAL_COLOR_PALETTE.medical.blue[700],
  'primary-light': MEDICAL_COLOR_PALETTE.medical.blue[100],
  'primary-dark': MEDICAL_COLOR_PALETTE.medical.blue[800],

  // Secondary Colors
  secondary: MEDICAL_COLOR_PALETTE.medical.green[500],
  'secondary-hover': MEDICAL_COLOR_PALETTE.medical.green[600],
  'secondary-light': MEDICAL_COLOR_PALETTE.medical.green[100],

  // Accent Colors
  accent: MEDICAL_COLOR_PALETTE.medical.cyan[500],
  'accent-hover': MEDICAL_COLOR_PALETTE.medical.cyan[600],
  'accent-light': MEDICAL_COLOR_PALETTE.medical.cyan[100],

  // Background Colors
  background: MEDICAL_COLOR_PALETTE.neutral.white.pure,
  'background-secondary': MEDICAL_COLOR_PALETTE.neutral.white.soft,
  'background-tertiary': MEDICAL_COLOR_PALETTE.neutral.gray[50],

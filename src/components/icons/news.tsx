...
export default function NewsIcon({ active, ...props }: NewsIconProps) {
  // Blue color hex code
  const blueColor = '#3b82f6'; // Tailwind blue-500

  return (
    <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g clipPath="url(#clip0_news)">
        <g clipPath="url(#clip1_news)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            ...
            fill={active ? blueColor : blueColor}
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
      ...
      <defs>
        ...
        <clipPath id="clip1_news">
          <rect width="20.3" height="20.3" fill="white" transform="translate(2.84961 2.84912)" />
        </clipPath>
      </defs>
    </svg>
  );

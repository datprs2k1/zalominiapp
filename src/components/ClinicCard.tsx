    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-center text-left z-10">
        ...
        >
          ...
          <motion.a
            href={`tel:${phone}`}
            className="bg-gradient-to-r from-primary to-primary-hover text-white px-4 py-2.5 rounded-lg flex items-center gap-2 text-sm font-semibold shadow-button hover:shadow-button-hover transition-all medical-focus"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            aria-label={`Gọi điện thoại ${phone}`}
          >

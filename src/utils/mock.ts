...
export async function mock7DaysTimeSlots() {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    slots.push({
      date,
      slots: [], // Empty slots array since we don't need time slots anymore
    });
  }
  ...
  return [
    {
      ...
      description: 'Cục An toàn thực phẩm đề nghị Viện Dinh dưỡng quốc gia, Sở Y tế Đồng Nai kiểm tra',
      category: 'Sức khỏe',
